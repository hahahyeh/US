...
function Footer() {
  ...
  return (
    <div className="footer">
      <div className="footer-us">US</div>
      <div className="footer-address">
        서울특별시 용산구 청파동2가 청파로47길 100
        <br />
        숙명여자대학교
      </div>
      &nbsp;
      <div className="footer-tos">
        <React.Fragment>
          <button className="footer-tos1" onClick={openModal1}>
            이용약관
          </button>{" "}
          &nbsp; &nbsp; &nbsp;
          <Modal2 open={modalOpen1} close={closeModal1} header="이용약관">
            <div className="footer-tos1-text">
              제 1 장 총칙
              <br />
              <br />
              제 1 조 (목적)
              <br />
              본 약관은 US가 운영하는 웹 사이트의 제반 서비스의 이용조건 및
              ...
              <br />
              회사가 회원 가입과 관련해 취득한 개인 신용 정보는 신용정보의 이용
              및 보호에 관한 법률 제23조의 규정에 따라 타인에게 제공 및 활용 시
              이용자의 동의를 얻어야 한다. 이용자의 동의는 회사가 회원으로
              가입한 이용자의 신용정보를 신용정보기관, 신용정보업자 및 기타
              이용자 등에게 제공해 이용자의 신용을 판단하기 위한 자료로서
              ...
              <br />
              -부칙-
              <br />본 약관은 2021년 11월 19일부터 적용한다.
            </div>
          </Modal2>
        </React.Fragment>
        <React.Fragment>
          <button className="footer-tos2" onClick={openModal2}>
            개인정보처리방침
          </button>
          <Modal2
            open={modalOpen2}
          ...
          >
            <div className="footer-tos1-text">
              US ('https://usus.paas-ta.org/'이하 'US')은(는) 「개인정보
              ...
              제1조(개인정보의 처리 목적)
              <br />
              US('https://usus.paas-ta.org/'이하 'US')은(는) 다음의 목적을
              ...
              <br />
              ① US 은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
              ...
              <br />
              ① 정보주체는 US에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
              요구 등의 권리를 행사할 수 있습니다.
              <br />
              ② 제1항에 따른 권리 행사는US에 대해 「개인정보 보호법」 시행령
              제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
              수 있으며 US은(는) 이에 대해 지체 없이 조치하겠습니다.
              <br />
              ...
              <br />
              ⑥ US은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
              처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
              대리인인지를 확인합니다.
              <br />
              제4조(처리하는 개인정보의 항목 작성)
              <br />
              ① US 은(는) 다음의 개인정보 항목을 처리하고 있습니다.
              <br />
              1 홈페이지 회원가입 및 관리
              <br />
              필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 생년월일,
              이름, 서비스 이용 기록, 접속 로그, 접속 IP 정보
              <br />
              제5조(개인정보의 파기)
              <br />
              ① US 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
              ...
              1. 파기절차
              <br />
              US 은(는) 파기 사유가 발생한 개인정보를 선정하고, US 의 개인정보
              ...
              제6조(개인정보의 안전성 확보 조치)
              <br />
              US 은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
              있습니다.
              <br />
              1. 개인정보의 암호화
              <br />
              ...
              <br />
              ① US 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
              ...
              있습니다. 제8조 (개인정보 보호책임자)
              <br />
              ① US 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
              ...
              아래의 부서에 할 수 있습니다.
              <br /> US 은(는) 정보주체의 개인정보 열람청구가 신속하게
              처리되도록 노력하겠습니다.
              <br />
              제10조(권익침해 구제방법)
              <br />
